...
export class EffectRegistry {
  ...
  getRubanEffect(id) {
    return this.registry.get(id) ?? this.registry.get(DEFAULT_EFFECT_ID);
  }
  ...
  getEffectsForType(type) {
    return Array.from(this.registry.values()).filter(effect => effect.types.includes(type));
  }
...
// Export the effect registry class for legacy conversions or custom registries.
export const effectsRegistry = new EffectRegistry();*/